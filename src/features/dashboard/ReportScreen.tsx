...
const getSvgComponent = (item: string) => {
  ...
  switch (item) {
    case 'Recharge & Utilities':
      return <RechargeSvg {...props} />;
    case 'IMPS/NEFT':
    case 'Money Transfer':
      return <IMPSsvg {...props} />;
    case 'AEPS/AadharPay':
      return <AadharPay {...props} />;
    case 'M-POS':
    case 'POS ATM':
      return <MPOSsvg {...props} />;
    case 'M-ATM':
    case 'MicroATM Rental Report':
      return <Matmsvg {...props} />;
    case 'PAN Card':
      return <Pansvg {...props} />;
    case 'Cash Deposit':
      return <Cashsvg {...props} />;
    case 'Flight Booking':
      return <Flightsvg {...props} />;
    case 'Bus Booking':
    case 'Travel':
      return <Bussvg {...props} />;
    ...
    case 'Cash Pickup Prepay Report':
      return <Walletansvg {...props} />;
    case 'Cash Pikup':
      return <RadintPickupSvg {...props} />;
    case 'Security':
      return <Finosvg {...props} />;
    default:
      return null;
  }
};
...
const ReportScreen = () => {
  ...
  const handlePress = useCallback(
    (item: string) => {
      const route =
        item === translate('Recharge & Utilities') && IsDealer
          ? translate('DealerRechargeHistory')
          : ROUTE_MAP[item];
      if (route) {
