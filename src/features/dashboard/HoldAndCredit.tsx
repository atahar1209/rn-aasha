...
const fmt = (val: any) => (val == null || val === '' ? '₹0.00' : `₹${val}`);
...
const StatPill = ({
  ...
  <View style={styles.statPill}>
    ...
    <Text style={styles.statLabel}>{translate(label)}</Text>
        ...
        {loading ? (
          ...
          <>
            ...
            <View style={styles.holdCard}>
              ...
              {/* Info strip */}
              <View
                style={[styles.holdStrip, {backgroundColor: `${primary}10`}]}>
