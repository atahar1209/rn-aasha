...
const QuickAccessScreen = () => {
  const {colorConfig, fcmToken} = useSelector(
  ...
  return (
    <View style={styles.main}>
      <LinearGradient
        ...
        <AppBar title={'your_quick_access'} />
        ...
        <ScrollView>
          <View style={styles.Container}>
            <SvgXml
              ...
              width={wScale(100)}
              height={wScale(100)}
              style={{alignSelf: 'center', marginBottom: hScale(20)}}
            />
            ...
            <View style={styles.Headers2}>
              ...
              <View style={styles.headercontant}>
                <IconButtons
                  isQuickAccess={true}
                  buttonData={rechargeSectionData}
                  getItem={getItem}
                />
              </View>
            </View>
            ...
            <View style={styles.Headers2}>
              ...
              <View style={styles.headercontant}>
                <IconButtons
                  ...
                  getItem={translate('other_section')}
                />
              </View>
            </View>
          </View>
