...
const getSvgComponent = (item: string) => {
  ...
  switch (item) {
    case 'Day Earning':
      return <DayEarnsvg {...props} />;
    case 'Ledger':
    case 'Day Ledger':
      return <DayLedgerSvg {...props} />;
    case 'Day & Month Book':
    case 'Day Book':
      return <DayBookSvg {...props} />;
    case 'Added Money':
      return <AddedMoneySvg {...props} />;
    case 'R TO R':
      return <RToRSvg {...props} />;
    case 'Credit Report':
      return <Paymentsvg {...props} />;
    case 'Fund Transfer History':
    case 'R TO R Report':
      return <RToRiportSvg {...props} />;
    case 'Fund Receive Report':
      return <FundReceivedSvg {...props} />;
    case 'Operator Commission':
      return <OperatorCommissionSvg {...props} />;
    case 'Manage A/C':
      return <ManageAccountSvg {...props} />;
    case 'Purchase order Report':
      return <PurchaseOrderSvg {...props} />;
    case 'Dispute Report':
      return <DisputeSvg {...props} />;
    case 'Other Links':
      return <OtherLinksSvg {...props} />;
...
const AccReportScreen = () => {
  ...
  const gridItems = useMemo(
    () => [
      ...
      IsDealer ? translate('Ledger') : translate,
      IsDealer ? translate('Day & Month Book') : translate('Day Book'),
      ...(!IsDealer ? ['Added Money', 'R TO R'] : []),
      ...(IsDealer ? ['Credit Report'] : []),
      IsDealer
        ? translate('Fund Transfer History')
