          ...
          <View style={styles.cardTopRow}>
            ...
            <View
              ...
              <Text
                style={[
                  styles.amountText,
                  {color: isCr ? '#15803D' : isDr ? '#B91C1C' : '#8E8E93'},
                ]}>
                ₹{item.Amount}
              </Text>
            </View>
            ...
            {item.Comm !== 0 && (
              <View style={[styles.chip, {backgroundColor: '#FEF3C7'}]}>
                <Text style={[styles.chipText, {color: '#92400E'}]}>
                  {translate('Comm')} {item.Comm > 0 ? '+' : ''}₹{item.Comm}
                </Text>
              </View>
            )}
            <View style={[styles.chip, {backgroundColor: '#F2F2F7'}]}>
              <Text style={[styles.chipText, {color: '#6C6C70'}]}>
                {item.Operator_type}
              </Text>
            </View>
          </View>
