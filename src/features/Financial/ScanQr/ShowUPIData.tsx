...
const ShowUPIData = ({route}) => {
  const {userId, Loc_Data, colorConfig} = useSelector(
    ...
    <KeyboardAwareScrollView
      ...
      <ScrollView
        ...
        <Animated.View style={[styles.glassCard, makeSlide(fadeAnim)]}>
          ...
          <View
            style={[styles.divider, {backgroundColor: `${primaryColor}15`}]}
          />
          ...
          <Animated.View style={[styles.infoRow, makeSlide(row2Anim)]}>
            ...
            <View style={styles.infoTextBlock}>
              ...
              <Text
                style={[styles.infoValue, {color: secondaryColor}]}
                numberOfLines={1}>
                {upi.pa}
              </Text>
            </View>
              ...
              <Animated.View key={val}>
                <View
                  style={[
                    ...
                    {
                      borderColor:
                        amount === val ? primaryColor : `${primaryColor}30`,
                      backgroundColor:
                        amount === val
                          ? `${primaryColor}18`
