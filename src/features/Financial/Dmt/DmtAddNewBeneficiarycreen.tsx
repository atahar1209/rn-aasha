            ...
            notification: {
              ...
              body:
                ...
                `${translate('Details')} - ${translate(
                  ...
                  ' Acc No',
                )} :${accountNumber},  ${translate('Mo')} : ${senderNo}`,
            },
          };
    ...
    try {
      ...
      if (res.RESULT === '1') {
        ...
        if (statusCode === 'IAN') {
          ...
          Alert.alert(
            translate('Message'),
            res?.ADDINFO?.data?.bankrefno || res?.ADDINFO?.status,
            [{text: translate('OK'), onPress: () => {}}],
          );
        }
          ...
          notification: {
            ...
            body:
              ...
              `${translate('Details')} - ${translate(
                ...
                'Mo',
              )} : ${senderNo}, ${translate('Bank Ref No')} :${bankrefno}`,
          },
        };
          ...
          return (
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={[styles.operatornametext]}>{item.bank_name}</Text>
              </TouchableOpacity>
            </View>
          );
        }}
          ...
          <TouchableOpacity
            onPress={() => {
              if (
                ...
                ToastAndroid.show(
                  translate('Please enter and match Account Numbers first'),
                  ToastAndroid.SHORT,
                );
              }
            }}>
            ...
            <DynamicButton
              ...
              onPress={() => {
                if (accountNumber === reEnterAccountNumber) {
                  ...
                  ToastAndroid.show(
                    translate('Account numbers do not match!'),
                    ToastAndroid.BOTTOM,
                  );
                }
              }}
              ...
              {verificationDetails && (
                <View style={{marginVertical: 10}}>
                  <Text style={{color: colors.black}}>
                    {translate('Name')}: {verificationDetails.name}
                  </Text>
                  <Text style={{color: colors.black}}>
                    {translate('Status')}: {verificationDetails.status}
                  </Text>
                  <Text style={{color: colors.black}}>
                    {translate('Ref No')}: {verificationDetails.bankRefNo}
                  </Text>
                </View>
              )}
              <View style={styles.buttonContainer}>
                <Button
                  title={translate('Confirm & Save')}
                  onPress={() => handleAddBeneficiary(name)}
                />
                <View style={{width: 20}} />
                <Button
