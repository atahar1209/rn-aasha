        ...
        if (res?.ADDINFO?.statuscode !== 'TXN') {
          ...
          const mockNotification = {
            notification: {
              ...
              body:
                res['ADDINFO']['status'] +
                `Details - Name :${name} ,Acc No :${accountNumber} ,Mo : ${senderNo}`,
            },
          };
      ...
      if (res.RESULT === '1') {
        ...
        const mockNotification = {
          notification: {
            ...
            body:
              res['ADDINFO']['status'] +
              `Details - Name :${bename} ,A/c No :${accountNumber} ,Mo : ${senderNo} ,Bank Ref No :${bankrefno}`,
          },
        };
          ...
          <TouchableOpacity
            onPress={() => {
              if (
                ...
                ToastAndroid.show(
                  'Please enter and match Account Numbers first',
                  ToastAndroid.SHORT,
                );
              }
            }}>
            ...
            <DynamicButton
              ...
              title={
                isLoading ? (
                  ...
                  <Text>
                    {GoodMark ? '✓ Verified' : translate('Verify Account')}
                  </Text>
                )
              }
            />
            ...
            <View style={styles.modalView}>
              ...
              {verificationDetails && (
                <View style={{marginVertical: 10}}>
                  ...
                  <Text style={{color: colors.black}}>
                    Ref No: {verificationDetails.bankRefNo}
                  </Text>
                </View>
              )}
