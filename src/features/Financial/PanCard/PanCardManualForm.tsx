  ...
  const handleManualPan = async () => {
    ...
    if (
      ...
      Alert.alert(
        ...
        translate('Please fill out all fields.'),
      );
      return;
    }
    ...
    if (!/^\d{10}$/.test(mobile)) {
      Alert.alert(
        translate('Invalid Mobile Number'),
        translate('Please enter a valid 10-digit mobile number.'),
      );
      return;
    }
    setisLoading(true);
    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <KeyboardAwareScrollView
        ...
        <View style={styles.container}>
          ...
          <FlotingInput
            label={translate('Enter Aadhar Reg. Mobile')}
            value={mobile2}
          ...
          <FlotingInput
            label={translate("Enter Father's Name")}
            value={father}
