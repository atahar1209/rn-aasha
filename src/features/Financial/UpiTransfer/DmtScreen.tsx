...
const UpiDmtScreen = ({route}) => {
    ...
    try {
      ...
      if (response) {
        ...
        Alert.alert(
          ...
          `${translate('UPI id')}: ${route.params.UpiId}\n${translate(
            'Time',
  ...
  return (
    <View style={styles.main}>
      ...
      {/* Top Info Card with Gradient */}
      <LinearGradient
        colors={[colorConfig.primaryColor, colorConfig.secondaryColor]}
        style={{paddingVertical: hScale(15)}}>
        <View style={styles.inercontainer}>
          {/* UPI ID & Sender Number Row */}
          ...
          {/* Unique ID Row */}
          <View style={[styles.rowContainer, {marginTop: hScale(10)}]}>
      ...
      <KeyboardAwareScrollView
        ...
        <View style={styles.container}>
          <View>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{
                    color:
                      !aadharvis && !panvisi ? colorConfig.labelColor : '#000',
                  }}>
                  {translate('None')}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{color: aadharvis ? colorConfig.labelColor : '#000'}}>
                  {translate('Aadhaar')}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{color: panvisi ? colorConfig.labelColor : '#000'}}>
                  {translate('PAN_Card')}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            {aadharvis && (
              <FlotingInput
                label={translate('Enter Aadhaar Number')}
                value={aadhar}
