        ...
        <ViewShot
          ...
          <View style={styles.topcontainer}>
            ...
            <View>
              ...
              <Text style={styles.title2}>
                {translate('CASH_MANAGEMENT_SERVICES_LIMITED')}
              </Text>
              <Text style={styles.companyISO}>
                {translate('An_ISO_9001_2015_Company')}
              </Text>
            </View>
            <FastImage
              source={getAssetSource('CmsSlipQr.jpg')}
          ...
          <View style={styles.container}>
            ...
            <Text style={styles.label}>
              {translate('Pickup_Point_Name_Address')}
            </Text>
            ...
            <View style={styles.row}>
              <View>
                <Text style={styles.label}>
                  {translate('Point_Contact_Person')}
                </Text>
                <Text style={styles.value}>{slipData.ClientName || '---'}</Text>
              </View>
              <View style={styles.rightColum}>
                <Text style={styles.label}>
                  {translate('Point_Mobile_Number')}
                </Text>
                <Text style={styles.value}>
                  {slipData.ClientMobile || '---'}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.row}>
              <View>
                <Text style={styles.label}>
                  {translate('PointClientShop_ID')}
                </Text>
                <Text style={styles.value}>{slipData.shop_id || '---'}</Text>
              </View>
              <View style={styles.rightColum}>
                <Text style={styles.label}>
                  {translate('Pickup_Transaction_ID')}
                </Text>
                <View
                  style={{
                    flexDirection: 'row',
            ...
            <View style={styles.amountWords}>
              <Text style={styles.amountWordsText}>
                {translate('Amount in Words')}:{' '}
                {slipData.Amountinwords || '---'}
              </Text>
            </View>

            <Text style={styles.footerText}>
              {translate('key_thisisa_157')}
            </Text>
          </View>
        </ViewShot>
      </ScrollView>
