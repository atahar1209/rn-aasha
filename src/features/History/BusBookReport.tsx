...
const BusBookReport = () => {
      ...
      <View style={styles.card}>
        <View style={styles.tileHeader}>
          <View style={styles.tileTitle}>
            ...
            <Text style={styles.text}>{`${translate('TicketDate')}: ${
              item.TicketDate
            }`}</Text>
            <Text style={styles.text}>{`${translate('TraceId')}: ${
              item.TraceId
            }`}</Text>
            <Text style={styles.text}>{`${translate('Email')}: ${
              item.Email
            }`}</Text>

            <Text style={styles.text}>{`${translate('transaction_id')}: ${
              item.reqid
            }`}</Text>
            <Text style={styles.text}>{`${translate('FareAmount')}: ${
              item.FareAmount
            }`}</Text>
            <Text style={styles.text}>{`${translate('PassengerName')}: ${
              item.PassengerName === ''
                ? translate('No Name')
                : item.PassengerNam
            }`}</Text>
            ...
            <Text style={styles.text}>{`${translate('Gst')} : ${
              item.RemGst
            }`}</Text>
            <Text style={styles.text}>{`${translate('TDS')} : ${
              item.RemTDS
            }`}</Text>
            <Text style={styles.text}>{`${translate('My Earn')} : ${
              item.Retailer_comm
            }`}</Text>
          </View>
          <View style={styles.tileStatus}>
            ...
            />
            <Text style={styles.text}>{translate(item.status)}</Text>
  ...
  return (
    <View style={styles.container}>
      <AppBarSecond title="Bus Booking Report" />
      <Options />
      {loading ? (
