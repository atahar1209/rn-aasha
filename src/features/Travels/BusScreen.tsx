...
const BusScreen = () => {
  ...
  return (
    <View style={styles.main}>
      ...
      <View
        style={[styles.topview, {backgroundColor: colorConfig.secondaryColor}]}>
        <Text style={styles.toptitle}>
          {translate('Search_for_Bus_Tickets')}
        </Text>

        <View style={styles.abhiview}>
          <Text style={{color: '#fff'}}>{translate('Powered_By')}</Text>
          <Text style={styles.abhi}>{translate('ambika')}</Text>
        </View>
      </View>
      ...
      <View style={styles.container}>
        <FlashList
          data={data}
          renderItem={Item => {
            return <Text>{data.id}dgsdfg</Text>;
          }}
        />
        <View style={styles.inputrow}>
          <View style={styles.inputview}>
            <View style={styles.inputiconrow}>
              <NavigationSvg />
              <TextInput
                placeholder={translate('From Station')}
                value={fromStation}
            ...
            <View style={styles.inputiconrow}>
              <LocationBusSvg />
              <TextInput
                placeholder={translate('To Station')}
                value={toStation}
                placeholderTextColor={colors.black75}
        ...
        <View>
          <TouchableOpacity
            ...
            style={[styles.inputiconrow, styles.disput]}>
            <Calendarsvg size={20} />

            <Text style={[styles.input, {marginLeft: wScale(8)}]}>
              {date === false ? translate('Select Your Date') : selectedDate}
            </Text>
          </TouchableOpacity>
        </View>
