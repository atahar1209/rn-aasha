      ...
      <View style={styles.card}>
        ...
        <LinearGradient
          ...
          <View style={styles.headerLeft}>
            <Text style={styles.headerRechargeLabel}>
              {translate('Recharge No')}
            </Text>
            <Text style={styles.headerRechargeNo}>
              {item.Rechargeno || '—'}
            </Text>
          </View>
        ...
        <View style={styles.cardBody}>
          ...
          <View style={styles.statsRow}>
            ...
            <StatCell label={translate('Operator')} value={item.opt || '—'} />
            <View style={styles.statDivider} />
            <StatCell
  ...
  const fetchReport = useCallback(
    async (from: string, to: string, status: string) => {
      ...
      try {
        ...
        if (!response) {
          throw new Error(translate('No response'));
        }
