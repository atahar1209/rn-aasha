    ...
    return (
      <View>
          ...
          <View style={styles.limitCard}>
            ...
            <View style={styles.statsBox}>
              <Text style={styles.remainText}>
                {translate('Remaining')}: ₹{Math.max(limit - total, 0)}
              </Text>
              <Text style={styles.spentText}>
                {translate('Spent')}: ₹{total}
              </Text>
              <TouchableOpacity
                style={[
                  styles.editBtn,
                ...
                <Text style={{color: colorConfig.labelColor, fontSize: 12}}>
                  {translate('Edit_Limit')}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={styles.inputCard}>
          <TextInput
            placeholder={translate('What did you buy?')}
            style={styles.input}
            value={title}
...
export default function MyExpenseApp() {
  ...
  const loadData = async () => {
    try {
      ...
      if (toggle) {
        setLimitEnabled(JSON.parse(toggle));
      }
    } catch (e) {
      console.log(e);
    }
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalButtons}>
                <TouchableOpacity
                  style={[styles.mBtn, {backgroundColor: '#ddd'}]}
                ...
                <TouchableOpacity
                  style={[
                    styles.mBtn,
                    {backgroundColor: colorConfig.primaryColor || '#3949ab'},
                  ]}
                  onPress={updateLimit}>
