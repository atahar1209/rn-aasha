...
const FinancialRow = React.memo(
  ({
    ...
    <View style={[styles.finRow, highlight && styles.finRowHighlight]}>
      <Text style={[styles.finLabel, highlight && styles.finLabelBold]}>
        {label}
      </Text>
      <Text style={[styles.finValue, highlight && styles.finValueBold]}>
        ₹{value}
      </Text>
    </View>
  ),
    ...
    return (
      <View style={styles.retailerCard}>
        ...
        <View style={styles.retailerCardBody}>
          ...
          <FinancialRow
            label={translate('Old Day Refund')}
            value={item.OLDDAYREFUND}
          />
          <FinancialRow
            label={translate('Old Day Failed')}
            value={item.OLDDAYFAILED}
          />

          <View style={[styles.diffRow, {backgroundColor: diffBg}]}>
            <Text style={styles.diffLabel}>
              {translate('Other Difference')}
            </Text>
...
const DealerCard = React.memo(
  ({item, themeColor}: {item: any; themeColor: string}) => (
      ...
      <View style={styles.dealerBody}>
        <View style={styles.dealerHeaderRow}>
          <View>
            ...
            <Text style={[styles.dealerType, {color: themeColor}]}>
              {item.Type}
            </Text>
          </View>
          <View style={styles.earnCol}>
            <Text style={styles.particularLabel}>{translate('Earn')}</Text>
            <Text style={[styles.earnAmount, {color: themeColor}]}>
              ₹{item.Amount}
            </Text>
          </View>
        </View>
