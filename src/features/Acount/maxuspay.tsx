...
const CommissionReport = () => {
  ...
  const typevalues = [
    translate('Daywise Commission'),
    translate('Day wise commission of user slab'),
    translate('Extracomm Report'),
  ];
  ...
  const daywisecomms = async (from, to, selected) => {
    ...
    try {
      ...
      const url =
        selected === 'Daywise Commission'
          ? url1
          : selected === 'Day wise commission of user slab'
          ? url3
          : selected === 'Extracomm Report'
          ? url2
          : '';
  ...
  return (
    <View style={styles.main}>
      <AppBarSecond title={translate('Day Book')} />
        ...
        <TouchableOpacity
          ...
          <View style={{}}>
            <Text
              ...
              {!selecteditem ? translate('Day Wise Commission') : selecteditem}
            </Text>
          </View>
        </TouchableOpacity>
      </LinearGradient>
