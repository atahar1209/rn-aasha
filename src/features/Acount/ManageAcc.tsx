...
const ManageAccount = () => {
  ...
  const [routes] = useState([
    {key: 'DmtBank', title: translate('Wallet Unload A/c')},
    {key: 'AepBank', title: translate('For Aeps Activetion A/c')},
  ]);
  ...
  return (
    <View style={styles.main}>
      <AppBarSecond title={translate('Manage Account')} />
      <TabView
        lazy
        ...
        renderTabBar={props => (
          <TabBar
            ...
            style={[styles.tabbar, {backgroundColor: colorConfig.primaryColor}]}
