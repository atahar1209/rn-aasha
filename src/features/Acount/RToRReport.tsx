  ...
  ({
    ...
    <View style={styles.card}>
      ...
      <LinearGradient
        ...
        <View style={styles.headerLeft}>
          ...
          <View style={styles.typeBadge}>
            <Text style={styles.typeBadgeText}>{translate(item.Type)}</Text>
          </View>
        </View>
      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.metaRow}>
          <View style={styles.datePill}>
            <Text style={styles.dateText}>{item.Date ?? translate('N/A')}</Text>
          </View>
          <View style={[styles.netBadge, {backgroundColor: `${themeColor}18`}]}>
            <Text style={styles.netLabel}>{translate('Net T/F')}</Text>
            <Text style={[styles.netValue, {color: themeColor}]}>
              ₹{item.TotalBal}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statDivider} />
          <StatCell
            label={translate('Old_Credit')}
            value={
              item.RetailerOldCr != null ? `₹${item.RetailerOldCr}` : 'N/A'
            }
          />
          <View style={styles.statDivider} />
          <StatCell
            label={translate('Charge')}
...
const RToRReport = () => {
  ...
  const fetchData = useCallback(
    ...
    [selectedRetailerId, IsDealer, userId, get, post],
  );
    ...
    <View style={styles.root}>
      ...
      <LinearGradient
        ...
        <AppBarSecond
          title={
            IsDealer
              ? translate('Fund_Transfer_Report')
              : translate('R_To_R_History')
          }
