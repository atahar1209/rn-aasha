  ...
  const renderRow = (
    ...
    return (
      <View style={styles.row}>
        <Text style={[styles.cell, styles.firstcell, styles.borderRight]}>
          {amountRange}
        </Text>
    ...
    <View style={styles.container}>
      <View style={[styles.labelview, {backgroundColor: color1}]}>
        <Text style={[styles.label]}>
          {translate('Mini_Statement_Commercial')}
        </Text>
        <Text style={[styles.value]}>0</Text>
      </View>
      <View style={[styles.labelview, {backgroundColor: color1}]}>
        <Text style={[styles.label]}>
          {translate('Aadhaar_Pay_Commercial')}
        </Text>
        <Text style={[styles.value]}>0</Text>
      </View>
      <View style={[styles.header, {backgroundColor: color1}]}>
        <Text style={[styles.headerCell, styles.borderRight, styles.firstcell]}>
          {translate('Amount_Range')}
        </Text>
        <Text style={[styles.headerCell, styles.borderRight]}> (%) </Text>
        <Text style={[styles.headerCell, styles.borderRight]}> (₹) </Text>
        <Text style={styles.headerCell}>{translate('max')}</Text>
      </View>
