        ...
        <View
          ...
          <View
            ...
            <View style={styles.item2}>
              <Text style={styles.timeLabel}>
                {translate('Request_Update_Time')}
              </Text>
              <Text style={styles.timeVabel}>
                {item.Updatedate || translate('N/A')}
              </Text>
            </View>
          </View>
          ...
          <View style={[styles.rMargin, {borderColor: color}]}>
            <View style={styles.row}>
              <View style={styles.item}>
                <Text style={styles.label}>{translate('Account_Number')}</Text>
                <Text style={styles.value}>
                  {item.Accountnumber || translate('NULL')}
                </Text>
              </View>
            ...
            <View style={styles.row}>
              <View style={styles.item}>
                <Text style={styles.label}>{translate('Slip_ID')}</Text>
              </View>
              <View style={styles.item2}>
                <Text style={[styles.value, styles.textUpper]}>
                  {item.Slipid || translate('NULL')}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.row}>
              <View style={styles.item}>
                <Text style={styles.label}>{translate('Response_By')}</Text>
              </View>
              <View style={styles.item2}>
                <Text style={styles.value}>
                  {item.ResponseBy || translate('NULL')}
                </Text>
              </View>
            </View>
            ...
            <>
              <Text style={styles.footerTitle}>
                {translate('DepositTransaction_Slip')}
              </Text>
              <View style={styles.btnRow}>
                <TouchableOpacity
                  ...
                  <Text style={styles.btnText}>{translate('View_Slip')}</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.btnStyle} onPress={handleShare}>
                  <Text style={styles.btnText}>{translate('Share')}</Text>
                </TouchableOpacity>
