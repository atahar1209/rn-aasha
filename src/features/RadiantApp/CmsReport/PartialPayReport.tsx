...
export default function PartialPayReport({Shopid, currentAmount}) {
  ...
  }, [totalAmount, currentAmount, dispatch]);
      ...
      {data.length > 0 && (
        <View style={commonStyles.screenContainer}>
          <Text style={styles.title}>
            {translate('Todays_Partial_Payment')}
          </Text>
          ...
          <View style={styles.table}>
            ...
            <View
              ...
              <Text style={[styles.cell, styles.totleL]}>
                {translate('Total_Amount')}
              </Text>
              <Text style={[styles.cell, styles.headerText, styles.totleL]}>
                {totalAmount}
              </Text>
            </View>
          </View>
