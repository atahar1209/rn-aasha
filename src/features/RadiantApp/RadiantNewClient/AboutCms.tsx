        ...
        <View style={styles.mapview}>
          <View style={styles.mapcontant}>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('key_thecompan_165')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('key_cashcolle_166')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('current_accounts_and_subsequent')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('transfer_to_the_clients_accounts_either')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('on_the_same_day_or_on_the_next')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('working_day_The_Company')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('believes_that_our_network_of_more')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('than_60000_touch_points_and_a')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('wide_network_of_bank_accounts_with')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('various_banks_across_the_country')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('allows_use_to_offer_a_unique_value')}
            </Text>
            <Text style={[styles.aboutText, {marginBottom: 0}]}>
              {translate('proposition_to_company_clients')}
            </Text>
            <Text style={[styles.aboutText]}>
              {translate('key_especially_167')}
            </Text>
          </View>
          <View style={styles.matimg}>
            <FastImage
              source={getAssetSource('map.png')}
