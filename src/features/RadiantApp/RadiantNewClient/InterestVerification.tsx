  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>
        <Text style={styles.headingE}>{translate('E')}</Text>
        <Text style={styles.headingX}>{translate('xclusive')}</Text>
      </Text>
      ...
      <Text style={[styles.description, {color: colorConfig.secondaryColor}]}>
        {translate(
          'We_are_introducing_you_to_Radiant_Cash_Management_Services_Limited_one_of_the_largest_CMS_service_providers_in_India',
        )}
      </Text>
      <DynamicButton
