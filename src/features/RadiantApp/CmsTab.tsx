...
const CmsTab = () => {
    ...
    <FlatList
      ...
      renderItem={({item}) => (
        <TouchableOpacity
          ...
          <View style={[styles.svgimg, {backgroundColor}]}>{item.img}</View>
          <View style={[styles.inveiw]}>
            <Text style={styles.cardText}>{translate(item.title)}</Text>
  ...
  const transactions1: TransactionItem[] = [
    {
      id: '1',
      title: translate('Add New Pickup Request'),
    ...
    ...(rctype === 'PrePay'
      ? [
          {
            id: '2',
            title: translate('RCE Cash Pickup Report'),
            description: translate(
    ...
    {
      id: '4',
      title: translate('RCE Cash Pickup calendar'),
      description: translate(
    ...
    {
      id: '5',
      title: translate('RCE Payout Information'),
      description: translate(
    ...
    ...(rctype === 'PostPay'
      ? [
          {
            id: '6',
            title: translate('Pickup & Deposit Ledger'),
            description: translate(
              'Money is picked up by RCE from the customer point or dropped off by the customer and through whatever medium the money is given to the company, the complete credit debit report will be in this ledger.',
            ),
  ...
  const transactions2: TransactionItem[] = [
    ...(rctype === 'PostPay'
      ? [
          {
            id: '1',
            title: translate('Pay picked & Due Amount'),
            description: translate(
          ...
          ...(rctype === 'PostPay'
            ? [
                {
                  id: '2',
                  title: translate('Cash & Online Deposit Report'),
                  description: translate(
                    'In this report, the money deposited by RCE in the bank cash counter, the money deposited in the Cash Deposit Machine (CDM) and the money transferred by any other online mode can be seen in this report.',
                  ),
          ...
          {
            id: '3',
            title: translate('Transfer Report by Wallet'),
            description: translate(
              'The report of all the payments deposited through Main Wallet and POS Wallet is available here. Also, the report of live payments made through QR code, Intent UPI mode is also available here.',
            ),
    ...
    {
      id: '4',
      title: translate('Set Additional Pin Code'),
      description: translate(
    ...
    {
      id: '5',
      title: translate('My Referred Customer Points'),
      description: translate(
  ...
  const transactions3: TransactionItem[] = [
    {
      id: '1',
      title: translate('Manual Add Money Report'),
      description: translate(
    ...
    {
      id: '2',
      title: translate('Cash Deposit A/C List'),
      description: translate(
    ...
    {
      id: '3',
      title: translate('Deposit Slip for CMS'),
      description: translate(
    ...
    {
      id: '4',
      title: translate("Company Doc's for Deposit"),
      description: translate(
  ...
  const [routes] = useState([
    {
      ...
      title:
        rctype === 'PrePay'
          ? translate('Pickup & Payout')
          : translate('Cash Pickup'),
    },
    {
      key: 'cashDeposit',
      title:
        rctype === 'PrePay'
          ...
          : translate('Cash Deposit'),
    },
    {
      key: 'other',
      title:
        rctype === 'PrePay' ? translate("Other's Info") : translate("Other's"),
    },
  ]);
