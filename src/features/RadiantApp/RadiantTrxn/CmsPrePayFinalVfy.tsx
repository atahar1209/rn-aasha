...
const CmsPrePayFinalVfy = ({}) => {
  const {colorConfig, Loc_Data, cmsVerify, rctype, rcPrePayAnomut} =
    ...
    <View style={styles.main}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          />
          <Text style={styles.sorryT}>{translate('Sorry')},</Text>
          <Text style={styles.sorryD}>
            {translate('the required balance is not available.')}
          </Text>
          {Number(amountneed) > 0 && (
