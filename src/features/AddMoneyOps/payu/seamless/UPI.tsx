...
const UPI = (routeData, props) => {
  ...
  const initiatePayment = (mode, packageName = 'null') => {
    ...
    commonParams['hashes']['payment'] = getPaymentHash(
      commonParams,
      route.salt,
    );
      ...
      async results => {
        ...
        try {
          ...
          if (response.Response === 'success') {
            ...
            ToastAndroid.show(
              response.Message || translate('Failed'),
              ToastAndroid.SHORT,
            );
          ...
          Alert.alert(
            translate('Error'),
            translate('An error occurred while processing the request.'),
          );
        }
  ...
  const validateVPA = () => {
    ...
    commonParams['hashes']['validate_vpa'] = getVPAHash(
      commonParams,
      route.salt,
    );
    const requestData = {
    ...
    PayUUPI.validateVPA(
      ...
      error => {
        ...
        console.log(error);
        displayAlert(translate('Error validateVPA'), error);
      },
      params => {
        ...
        Alert.alert(
          translate('validateVPA'), // Title of the alert
          `${translate('Status')}: ${Response.status || translate('N/A')}\n` +
            `${translate('VPA')}: ${Response.vpa || translate('N/A')}\n` +
            `${translate('Is VPA Valid')}: ${
              Response.isVPAValid ? translate('Yes') : translate('No')
            }\n` +
            `${translate('Payer Name')}: ${
              Response.payerAccountName || translate('N/A')
            }\n`,
          [{text: translate('OK')}],
        );
      },
  ...
  const daaa = {
    result: {
      mihpayid: 22396456698,
      mode: 'UPI',
      status: 'success',
      key: 'TyfBJu',
      txnid: '1738842938994',
      amount: '1.00',
      addedon: '2025-02-06 17:25:39',
      productinfo: 'Mobile Phone',
      firstname: 'Kartick Sheel',
      lastname: '',
      address1: '',
      address2: '',
      city: '',
      ...
      country: '',
      zipcode: '',
      email: 'kartick.drishti2019@gmail.com',
      phone: '8918620113',
      udf1: 'udf1',
      udf2: 'udf2',
      udf3: 'udf3',
      ...
      field1: '',
      field2: '980295',
      field3: '9370521211@ybl',
      field4: '',
      field5: 'rechargedrishti.payu@indus',
      field6: 'PPPL2239645669806022517254067a4a33c',
      ...
      hash: '95757903b94f9a77fc3d103d3c658d460165c1e24e0154a2ccc5ea15ecd1a84e1fef4cbbff145a2d1a23c10d3396901b25da7e39ff099aefdf997fc66d433daf',
      bank_ref_no: '668870039857',
      bank_ref_num: '668870039857',
      bankcode: 'INTENT',
      surl: 'https://www.rechargedrishti.com/Response/GatewayResponse',
      curl: 'instamoney.net.in/',
      furl: 'instamoney.net.in/',
    },
    status: 'success',
  };
  const sendResponse = async () => {
    ...
    if (!data['result']) {
      ...
      Alert.alert(
        translate('Error'),
        translate('Invalid response from server.'),
      );
      return;
    }
  ...
  const renderItem = ({item}) => (
    <View style={styles.walletItem}>
      <Text style={styles.walletText}>{translate(item.title)}</Text>
    </View>
  );
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  initiatePayment(translate('INTENT'), item.value)
                }>
