...
`,
    ...
    //     {
    //       key: '8', texts: [{ text: 'Login Device Informations', style: styles.text1 },
    //       {
    // text:'Login information helps ensure secure access by tracking the method, time, and location of logins, aiding in detecting unauthorized activity and ensuring system security. Accurate tracking also helps identify potential fraud and troubleshoot issues.'
    //          , style: styles.text2
    //       }],
    //       svg:
