...
const ManageLogin = () => {
  ...
  const BtnPress = () => {
    Dialog.show({
      ...
      textBody: translate('Want To block This Device'),
      button: translate('OK'),
      onPressButton: () => {
        Dialog.hide();
      },
  ...
  const BtnPress2 = () => {
    Dialog.show({
      type: ALERT_TYPE.WARNING,
      title: translate('Are You Sure !'),
      textBody: translate('Want To Unblock This Device'),
      button: translate('OK'),
      onPressButton: () => {
        Dialog.hide();
      },
  ...
  const Btnpress3 = () => {
    Dialog.show({
      ...
      textBody: translate('Your State Update Successfully.'),
      button: translate('OK'),
      onPressButton: () => {
        Dialog.hide();
        setShowModal(false);
  ...
  return (
    <View style={styles.main}>
      <AppBarSecond title="Manage Login Devices" />
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          <DynamicSecurityPages
            ...
            topsvgimg={topsvgimg}
            title={translate('Mobile Application (APP)')}
            content={translate('Mobile description')}
            secondtitle={translate('Live Status is')}
            selectedtext={appLoginEnabled ? translate('ON') : translate('OFF')}
            selecttexcolor={{
              fontWeight: 'bold',
              color: appLoginEnabled ? 'green' : 'red',
            }}
            buttonText={translate('Yes I Need High Security')}
            buttonstyle={[
              styles.button,
              {backgroundColor: colorConfig.primaryColor},
            ]}
            buttontextstyle={styles.btntext}
            buttonText={translate('Go to Block')}
            onPressBtn={() => setShowModal(true)}
            buttonImg={undefined}
            onPressImg={undefined}
          />
          ...
          <Modal transparent={true} animationType="fade" visible={showModal}>
            <View style={styles.modalcenter}>
              <View
                ...
                <DynamicOtp otp={undefined} setOtp={undefined} />
          ...
          <DynamicSecurityPages
            ...
            topsvgimg={help}
            title={translate('Website Login (Web)')}
            content={translate('Website description')}
            secondtitle={translate('Live Status is')}
            selectedtext={webLoginEnabled ? translate('ON') : translate('OFF')}
            buttonText={
              webLoginEnabled
                ? translate('Go to Block')
                : translate('Go to Unblock')
            }
            selecttexcolor={{
              color: webLoginEnabled ? 'green' : 'red',
              fontWeight: 'bold',
            }}
            buttonstyle={[
              styles.button,
            ...
            buttontextstyle={styles.btntext}
            buttonText={translate('Go to Unblock')}
            onPressBtn={() => setShowModal(true)}
            buttonImg={undefined}
            onPressImg={undefined}
          />
