...
const SearchBar = ({
  ...
  return (
    <View
      ...
      <Text
        style={[styles.searchIcon, {color: focused ? primaryColor : '#aaa'}]}>
        ⌕
      </Text>
      <TextInput
        value={value}
        ...
        {showState && (
          <View style={styles.stepRow}>
            ...
            <View
              style={[
                styles.stepLine,
                {backgroundColor: selectbool ? '#ddd' : primaryColor},
              ]}
            />
            <View
              style={[
            ...
            <Text style={[styles.stepText, {color: '#888'}]}>
              {selectbool
                ? translate('Step 1 of 2: Choose Operator')
                : translate('Step 2 of 2: Choose Circle')}
            </Text>
          </View>
        )}
