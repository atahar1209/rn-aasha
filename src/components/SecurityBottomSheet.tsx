...
const SecurityBottomSheet: React.FC<Props> = ({visible, onLater, onEnable}) => {
  ...
  }, [visible, backdropOpac, opacAnim, pulseAnim, scaleAnim]);
          ...
          <LinearGradient
            ...
            <View
              style={[
                ...
                {backgroundColor: hexAlpha(C.btnPri, 0.15)},
              ]}
            />
            <View
              style={[
                styles.circleTopLeft,
                {backgroundColor: hexAlpha(C.btnSec, 0.12)},
              ]}
            />
            <View
              style={[
            ...
            <View
              ...
              <Animated.View
                ...
                <View
                  style={[
                    styles.iconOuter,
                    {
                      backgroundColor: hexAlpha('#ffffff', 0.1),
              ...
              <Text
                style={[styles.description, {color: hexAlpha(C.label, 0.75)}]}>
                {translate('key_addalaye_136')}
              </Text>
              {/* Feature pills */}
              <View style={styles.pillRow}>
                {[
                  {icon: 'fingerprint', label: translate('Biometric')},
                  {icon: 'shield-check', label: translate('Secure')},
                  {icon: 'lightning-bolt', label: translate('Fast')},
                ].map(item => (
                  <View
                    key={item.label}
                    style={[
              ...
              <Pressable
                onPress={onLater}
                style={({pressed}) => [
                  {opacity: pressed ? 0.5 : 1, marginTop: hScale(12)},
                ]}>
                <View
                  style={[
                    styles.laterBtn,
                  ...
                  <Text
                    style={[styles.laterText, {color: hexAlpha(C.label, 0.8)}]}>
...
const styles = StyleSheet.create({
  ...
  // ── Modal card ──
  container: {
    width: SCREEN_WIDTH * 0.9, // 90% screen width
    maxWidth: 420,
    zIndex: 10,
  },
