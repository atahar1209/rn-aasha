...
const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({
  ...
  }, [showForgotPasswordModal, id, scaleAnim, opacAnim]);
  ...
  const internalHandleForgotPassword = useCallback(async () => {
    ...
    if (!isMobileValid && !isEmailValid) {
      const msg = translate('Please enter a valid mobile number or email.');
      Platform.OS === 'android'
              ...
              <Animated.View
                ...
                <LinearGradient
                  ...
                  <View
                    style={[
                      styles.circleBL,
                      {backgroundColor: hexAlpha(C.btnSec, 0.14)},
                    ]}
                  />
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {translate(
                        'Enter_your_mobile_number_or_email_ID_to_reset_your_password',
                      )}
                    </Text>
                    ...
                    <View
                      style={[
                        styles.divider,
                        {backgroundColor: hexAlpha(C.label, 0.18)},
                      ]}
                    />
                    ...
                    <Pressable
                      onPress={closeModal}
                      style={({pressed}) => [
                        {opacity: pressed ? 0.5 : 1, marginTop: hScale(10)},
                      ]}>
                      <View
                        style={[
                          styles.cancelBtn,
